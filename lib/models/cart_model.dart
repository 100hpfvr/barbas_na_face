...
// String request = "https://www.motoboy.com/apiV1/orcamento?cidade=rs%2Fporto-alegre&endereco1_cep=91788112&endereco2_cep=90690000";
double distancianumerada;
...
class CartModel extends Model {
 ...
 // Future<double> getData() async {}
  ...
  void _loadCartItens() async {
    // NOME DA FUNÇÃO ESCRITO DIFERENTE ====> ITEMS
    QuerySnapshot query = await Firestore.instance
        .collection("users")
        .document(user.firebaseUser.uid)
        .collection("cart")
